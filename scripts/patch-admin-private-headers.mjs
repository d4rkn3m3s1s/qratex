/**
 * Add PRIVATE_NO_STORE_HEADERS import and patch NextResponse.json in admin route.ts
 * (same logic as patch-dealer-private-headers.mjs).
 */
import fs from 'fs';
...
console.log('admin route.ts count', all.length, 'patched', targets.length);
