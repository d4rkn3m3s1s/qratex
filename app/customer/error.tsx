...
export default function CustomerError({
  ...
  return (
    <div
      ...
      role="alert"
    >
      <SkipToMainContent targetId="customer-error-main" label={t('customerError.skipToContent')} />
      <main
        id="customer-error-main"
        tabIndex={-1}
      ...
      >
        ...
        <h2 className="text-lg font-semibold">{t('customerError.title')}</h2>
