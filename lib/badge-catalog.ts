...
export const BADGE_CATALOG: BadgeCatalogEntry[] = [
  ...
  { id: 'badge-usta-yorumcu', name: 'Usta Yorumcu', description: '50 geri bildirim gönderdiniz!', category: 'feedback', pointCost: null, icon: `${B}/USTA YORUMCU.svg`, rarity: 'epic' },
  { id: 'badge-yorum-makinesi', name: 'Yorum Makinesi', description: 'Durmaksızın yorum yapıyorsunuz!', category: 'feedback', pointCost: null, icon: `${B}/YORUM MAKİNESİ.svg`, rarity: 'rare' },
  { id: 'badge-kelime-buyucusu', name: 'Kelime Büyücüsü', description: 'Uzun ve detaylı yorumlar yazdınız!', category: 'feedback', pointCost: null, icon: `${B}/KELİME BÜYÜCÜSÜ.svg`, rarity: 'rare' },
  { id: 'badge-hayalet-yorumcu', name: 'Hayalet Yorumcu', description: 'Gizlice yorum bırakıyorsunuz!', category: 'feedback', pointCost: null, icon: `${B}/HAYALET YORUMCU.svg`, rarity: 'common' },
  { id: 'badge-begeni-perisi', name: 'Beğeni Perisi', description: 'Hep olumlu geri bildirimler verdiniz!', category: 'engagement', pointCost: null, icon: `${B}/BEĞENİ PERİSİ.svg`, rarity: 'rare' },
  ...
  { id: 'badge-keskin-nisanci', name: 'Keskin Nişancı', description: 'Her yorumunuz isabetli ve yapıcı!', category: 'feedback', pointCost: null, icon: `${B}/KESKİN NİŞANCI.svg`, rarity: 'epic' },
  { id: 'badge-hizli-ofkeli', name: 'Hızlı ve Öfkeli', description: 'Çok hızlı ve tutkulu geri bildirimler!', category: 'speed', pointCost: null, icon: `${B}/HIZLI VE ÖFKELİ.svg`, rarity: 'rare' },
  { id: 'badge-sessiz-sinema', name: 'Sessiz Sinema', description: 'Fotoğraflarla geri bildirim verdiniz!', category: 'engagement', pointCost: null, icon: `${B}/SESSİZ SİNEMA.svg`, rarity: 'common' },
  { id: 'badge-konuk-oyuncu', name: 'Konuk Oyuncu', description: 'Yeni bir işletmeye ilk kez geri bildirim verdiniz!', category: 'exploration', pointCost: null, icon: `${B}/KONUK OYUNCU.svg`, rarity: 'common' },
  { id: 'badge-tur-rehberi', name: 'Tur Rehberi', description: '10 farklı işletmeyi ziyaret ettiniz!', category: 'exploration', pointCost: null, icon: `${B}/TUR REHBERİ.svg`, rarity: 'rare' },
  { id: 'badge-mucevher', name: 'Mücevher', description: '30 gün boyunca aktif kaldınız!', category: 'engagement', pointCost: null, icon: `${B}/MÜCEVHER.svg`, rarity: 'epic' },
  ...
  { id: 'badge-saatli-bomba', name: 'Saatli Bomba', description: 'Son dakikada yetişen geri bildirimler!', category: 'speed', pointCost: null, icon: `${B}/SAATLİ BOMBA.svg`, rarity: 'epic' },
  { id: 'badge-firtina', name: 'Fırtına', description: '7 gün üst üste geri bildirim gönderdiniz!', category: 'streak', pointCost: null, icon: `${B}/FIRTINA.svg`, rarity: 'epic' },
  { id: 'badge-filozof', name: 'Filozof', description: 'Derin ve düşündürücü yorumlar yazdınız!', category: 'feedback', pointCost: null, icon: `${B}/FİLOZOF.svg`, rarity: 'rare' },
  { id: 'badge-nostalji', name: 'Nostalji Rüzgarı', description: 'Eski bir işletmeyi tekrar ziyaret ettiniz!', category: 'engagement', pointCost: null, icon: `${B}/NOSTALJİ RÜZGARI.svg`, rarity: 'common' },
  { id: 'badge-ilham-kaynagi', name: 'İlham Kaynağı', description: 'Detaylı ve ilham verici geri bildirimler yazdınız!', category: 'feedback', pointCost: null, icon: `${B}/İLHAM KAYNAĞI.svg`, rarity: 'rare' },
  ...
  { id: 'badge-katalizor', name: 'Katalizör', description: 'Toplulukta değişime öncülük ettiniz!', category: 'engagement', pointCost: null, icon: `${B}/KATALİZÇR.svg`, rarity: 'epic' },
  ...
  { id: 'badge-yanki', name: 'Yankı', description: 'Yorumlarınız başkaları tarafından beğenildi!', category: 'feedback', pointCost: null, icon: `${B}/YANKI.svg`, rarity: 'common' },
  ...
  { id: 'badge-tetikci', name: 'Tetikçi', description: 'Hızlı ve etkili geri bildirimler!', category: 'speed', pointCost: null, icon: `${B}/TETİKÇİ.svg`, rarity: 'rare' },
  ...
  { id: 'badge-depresif', name: 'Depresif', description: 'Düşük puanlı geri bildirimler verdiniz!', category: 'general', pointCost: null, icon: `${B}/DEPRESİF.svg`, rarity: 'common' },
  { id: 'badge-drama-queen', name: 'Drama Queen', description: 'En dramatik yorumların sahibi!', category: 'general', pointCost: null, icon: `${B}/drama queen.svg`, rarity: 'common' },
  { id: 'badge-copy-cv', name: 'Copy CV', description: 'Profilinizi mükemmelleştirdiniz!', category: 'general', pointCost: null, icon: `${B}/copy cv.svg`, rarity: 'common' },
  ...
  { id: 'badge-filiz', name: 'Filiz', description: 'Yeni başlayan ama büyüyen bir kullanıcı!', category: 'general', pointCost: null, icon: `${B}/filiz.svg`, rarity: 'common' },
  { id: 'badge-huysuz', name: 'Huysuz', description: 'Eleştirel ama yapıcı geri bildirimler!', category: 'general', pointCost: null, icon: `${B}/huysuz.svg`, rarity: 'common' },
  { id: 'badge-jet', name: 'Jet', description: 'İnanılmaz hızda geri bildirim!', category: 'speed', pointCost: null, icon: `${B}/jet.svg`, rarity: 'rare' },
  { id: 'badge-kafein-bagimlisi', name: 'Kafein Bağımlısı', description: 'Kafe kategorisinde uzman oldunuz!', category: 'expertise', pointCost: null, icon: `${B}/kafein bağımlısı.svg`, rarity: 'common' },
  ...
  { id: 'badge-gurme', name: 'Gurme', description: 'Yemek kategorisinde uzman oldunuz!', category: 'expertise', pointCost: null, icon: `${B}/gurme.svg`, rarity: 'epic' },
  { id: 'badge-muhabbet-kusu', name: 'Muhabbet Kuşu', description: 'Çok konuşkan bir kullanıcısınız!', category: 'engagement', pointCost: null, icon: `${B}/muhabbet kuşu.svg`, rarity: 'common' },
