...
export const BADGE_CATALOG: BadgeCatalogEntry[] = [
  ...
  { id: 'badge-barney-stinson', name: 'Barney Stinson', description: 'Efsanevi olmak senin işin!', category: 'special', pointCost: null, icon: `${B}/BARNEY STİNSON.svg`, rarity: 'legendary' },
  { id: 'badge-chandler', name: 'Chandler Bing', description: 'Espri ustası! Her yorumun gülümsetiyor.', category: 'special', pointCost: null, icon: `${B}/CHANDLER BİİG.svg`, rarity: 'legendary' },
  { id: 'badge-sheldon', name: 'Sheldon Cooper', description: 'Bilimsel hassasiyetle geri bildirim!', category: 'special', pointCost: null, icon: `${B}/SHELDON COOPER.svg`, rarity: 'legendary' },
  { id: 'badge-the-office', name: 'The Office', description: 'Ofis hayatının en eğlenceli hali!', category: 'special', pointCost: null, icon: `${B}/THE OFFİCE.svg`, rarity: 'epic' },
  { id: 'badge-this-is-us', name: 'This is Us', description: 'Duygusal ve gerçek bağlantılar!', category: 'special', pointCost: null, icon: `${B}/THİS İS US.svg`, rarity: 'epic' },
  { id: 'badge-rick-morty', name: 'Rick & Morty', description: 'Wubba lubba dub dub! Bilimsel macera!', category: 'special', pointCost: null, icon: `${B}/RİCK AND MORTY.svg`, rarity: 'legendary' },
  // Fantastik / Dram / Gizem
  { id: 'badge-walter-white', name: 'Walter White', description: 'Kimya gibi mükemmel formüller!', category: 'special', pointCost: null, icon: `${B}/WALTER WHİTE.svg`, rarity: 'legendary' },
  { id: 'badge-jon-snow', name: 'Jon Snow', description: 'Kış geliyor... ama sen hazırsın!', category: 'special', pointCost: null, icon: `${B}/JON SNOW.svg`, rarity: 'legendary' },
  { id: 'badge-sherlock', name: 'Sherlock Holmes', description: 'Dedektif gibi detaycı geri bildirimler!', category: 'special', pointCost: null, icon: `${B}/SHERLOCK.svg`, rarity: 'legendary' },
  { id: 'badge-mr-robot', name: 'Mr. Robot', description: 'Sistemi çözdünüz!', category: 'special', pointCost: null, icon: `${B}/MR ROBOT.svg`, rarity: 'legendary' },
  { id: 'badge-professor', name: 'Profesör', description: 'Planınız mükemmel işledi!', category: 'special', pointCost: null, icon: `${B}/PROFESSOR.svg`, rarity: 'legendary' },
  { id: 'badge-the-doctor', name: 'The Doctor', description: 'Zaman ve mekanın ötesinde!', category: 'special', pointCost: null, icon: `${B}/THE DOCTOR.svg`, rarity: 'legendary' },
  { id: 'badge-eleven', name: 'Eleven', description: 'Süper güçler aktif!', category: 'special', pointCost: null, icon: `${B}/ELEVEN.svg`, rarity: 'epic' },
  { id: 'badge-wednesday', name: 'Wednesday', description: 'Karanlık ama zarif bir tarz!', category: 'special', pointCost: null, icon: `${B}/WEDNESDAY.svg`, rarity: 'epic' },
  { id: 'badge-dark-jonas', name: 'Dark Jonas', description: 'Zamanın döngüsünü kırdınız!', category: 'special', pointCost: null, icon: `${B}/DARK JONAS.svg`, rarity: 'epic' },
  { id: 'badge-dean-winchester', name: 'Dean Winchester', description: 'Doğaüstü güçlerle savaşan kahraman!', category: 'special', pointCost: null, icon: `${B}/DEAN WİNCHESTER.svg`, rarity: 'epic' },
  { id: 'badge-castiel', name: 'Castiel', description: 'Koruyucu melek gibi destekçi!', category: 'special', pointCost: null, icon: `${B}/CASTİEL.svg`, rarity: 'epic' },
  { id: 'badge-sam-winchester', name: 'Sam Winchester', description: 'Kardeşlik ve cesaret!', category: 'special', pointCost: null, icon: `${B}/SAM WİNCHESTR.svg`, rarity: 'epic' },
  { id: 'badge-witcher', name: 'Witcher Geralt', description: 'Hmm... Canavarlarla savaşan kahraman!', category: 'special', pointCost: null, icon: `${B}/WİTCHER GERALT.svg`, rarity: 'legendary' },
  // Dram / Suç / Gizem
  { id: 'badge-tokyo', name: 'Tokyo', description: 'Cesur ve kararlı bir kullanıcı!', category: 'special', pointCost: null, icon: `${B}/TOKYO.svg`, rarity: 'epic' },
  { id: 'badge-tommy-shelby', name: 'Tommy Shelby', description: 'Peaky Blinders tarzı liderlik!', category: 'special', pointCost: null, icon: `${B}/TOMMY SHELBY.svg`, rarity: 'legendary' },
  { id: 'badge-dexter', name: 'Dexter', description: 'Analitik zekayı geri bildirime döktünüz!', category: 'special', pointCost: null, icon: `${B}/DEXTER.svg`, rarity: 'epic' },
  { id: 'badge-pablo-escobar', name: 'Pablo Escobar', description: 'Puan imparatorluğu kurdunuz!', category: 'special', pointCost: null, icon: `${B}/PABLO ESCOBAR.svg`, rarity: 'legendary' },
  { id: 'badge-jesse-pinkman', name: 'Jesse Pinkman', description: 'Yeah Science! Bilimsel yaklaşım!', category: 'special', pointCost: null, icon: `${B}/JESSE PİNKMAN.svg`, rarity: 'epic' },
  { id: 'badge-carrie', name: 'Carrie Mathison', description: 'Sezgileri güçlü bir analist!', category: 'special', pointCost: null, icon: `${B}/CARRİE MATHİNSON.svg`, rarity: 'epic' },
  { id: 'badge-frank-underwood', name: 'Frank Underwood', description: 'Stratejik deha!', category: 'special', pointCost: null, icon: `${B}/FRANK UNDERWOOD.svg`, rarity: 'legendary' },
  { id: 'badge-hannibal', name: 'Hannibal', description: 'Sofistike zevkler ve keskin zeka!', category: 'special', pointCost: null, icon: `${B}/HANNİBAL.svg`, rarity: 'legendary' },
  { id: 'badge-house-md', name: 'House MD', description: 'Herkes yalan söyler... ama siz gerçeği bulursunuz!', category: 'special', pointCost: null, icon: `${B}/HOUSE MD.svg`, rarity: 'legendary' },
  { id: 'badge-joe', name: 'Joe', description: 'Takıntılı bir meraklı!', category: 'special', pointCost: null, icon: `${B}/JOE.svg`, rarity: 'epic' },
  { id: 'badge-villanelle', name: 'Villanelle', description: 'Tarz sahibi ve ölümcül çekici!', category: 'special', pointCost: null, icon: `${B}/VİLLANEVİLLE.svg`, rarity: 'epic' },
  // Tarih
  { id: 'badge-ragnar', name: 'Ragnar Lothbrok', description: 'Viking cesareti ile keşfe çıktınız!', category: 'special', pointCost: null, icon: `${B}/RAGNAR LOTHBROK.svg`, rarity: 'legendary' },
  { id: 'badge-spartacus', name: 'Spartacus', description: 'Özgürlük savaşçısı!', category: 'special', pointCost: null, icon: `${B}/SPARTACUS.svg`, rarity: 'legendary' },
  { id: 'badge-rome-julius', name: 'Julius Caesar', description: 'Veni, Vidi, Vici! Geldim, gördüm, yorum yaptım!', category: 'special', pointCost: null, icon: `${B}/ROME JULİUS.svg`, rarity: 'legendary' },
  { id: 'badge-elizabeth', name: 'Elizabeth', description: 'Kraliçe gibi zarafet!', category: 'special', pointCost: null, icon: `${B}/ELİZABETH.svg`, rarity: 'epic' },
  { id: 'badge-tyrion', name: 'Tyrion Lannister', description: 'İçerim ve bilir olurum!', category: 'special', pointCost: null, icon: `${B}/TYRİON LANNİSTER.svg`, rarity: 'legendary' },
  { id: 'badge-khalesi', name: 'Khaleesi', description: 'Ejderhaların anası! Güç sizinle!', category: 'special', pointCost: null, icon: `${B}/KHALESİ.svg`, rarity: 'legendary' },
  { id: 'badge-michael-scofield', name: 'Michael Scofield', description: 'Her detayı planlayan deha!', category: 'special', pointCost: null, icon: `${B}/MİCHAEL SCOLFİELD.svg`, rarity: 'legendary' },
  { id: 'badge-john-locke', name: 'John Locke', description: 'Adaya inanç, sisteme güven!', category: 'special', pointCost: null, icon: `${B}/JOHN LOCKE.svg`, rarity: 'epic' },
